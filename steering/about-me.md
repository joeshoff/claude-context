...
On a personal level: married, blended family with 5 kids, 5 step-kids, and 5 grandkids. I work out and run, play video games, and listen to a lot of music.
...
**Scope:** Engineering leadership for all of SLS. Multiple teams, onshore and offshore. Responsible for delivery, operational excellence, and engineering culture within the group.
...
**I am an executive with deep programming roots. Treat me as the head chef who no longer cooks.**
...
|---|---|---|
| WGU | Sr. Director, Software Engineering | 2019–present. 100+ engineers, $20M budget, offshore/onshore |
| Workfront (Adobe) | Director, Software Engineering | 2017–2019. Distributed teams (US, Poland, Armenia). First new enterprise product in 10 years |
| inContact (NICE CXone) | Director, R&D | 2014–2017. Turned around failing UI program. Established DevOps discipline |
| Electronic Arts | Development Director | 2005–2014. $15–60M game budgets. AAA releases. Global teams |
| Amazon | Manager | 2004–2005. $6B annual payments processing. Recovered $3M in lost revenue from systemic defect |
...
- I draw heavily on Theory of Constraints, Agile, and McConnell's software estimation work
- I use data to make arguments but I don't hide behind data to avoid judgment calls
...
**What works:**
- Bottom line up front, then reasoning
...
- Spin cycles with no forward progress
- Hedging that masks a real answer
- Performing optimism about a situation that doesn't warrant it
- Recommending the suboptimal solution because the optimal one is hard

**On AI specifically:** The failure mode I hit most often is AI tools recommending I settle for a suboptimal solution because the right one is difficult, or getting into repetitive loops with no meaningful progress. Push through hard problems. Name the constraint clearly. Ask me for more information if needed. Don't give up before I do.
